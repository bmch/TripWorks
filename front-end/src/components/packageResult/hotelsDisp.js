...
const hotelsDisp = ({i, dest}) => {
  ...
  return(
    <div className="resultBannerHotels">
        ...
        <div className="price">
<h2>€{(dest.hotels[i].price_breakdown.gross_price * dest.exchangeRate).toFixed(0)}</h2>
        </div>
        <div className="hotelIcon">
...
{dest.hotels[i].hotel_name_trans}</div>
            <h3 className="stars">
{dest.hotels[i].class}
              <svg className="star" viewBox="0 0 22 22" width="22" height="22" stroke="currentColor" stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round" class="css-i6dzq1"><polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"></polygon></svg>
            </h3>
          </div>
